class Speaker:
    ...
    def __str__(self):
        return f'Колонка "{self._name}" от {self._manufacturer}'

    def __repr__(self):
        return f'Speaker(name={self._name!r}, manufacturer={self._manufacturer!r})'


class WiredSpeaker(Speaker):
    """Класс для проводных колонок"""
    ...
    def __repr__(self):
        return f'WiredSpeaker(name={self._name!r}, manufacturer={self._manufacturer!r}, condition={self._condition!r})'


class WirelessSpeaker(Speaker):
    """Класс для беспроводных колонок"""
    ...
    def __repr__(self):
        return f'WirelessSpeaker(name={self._name!r}, manufacturer={self._manufacturer!r}, charge={self._charge!r})'
